...
export default function TableOrder() {
  ...
  const [facingMode, setFacingMode] = useState("user"); // default: front cam (for laptop)
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white">
      <h1 className="text-2xl font-bold mb-6">📷 Order via Table QR</h1>
      ...
      {scanned && (
        <p className="mt-4 text-green-400 break-all">✅ Scanned: {scanned}</p>
      )}
